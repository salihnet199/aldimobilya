        ...
        <div className={styles.grid}>
          ...
          <div className={styles.infoCol}>
            <div className={styles.card}>
              ...
              <div>
                <h2 className="heading-md" style={{ marginBottom: 'var(--space-1)' }}>Hızlı İletişim (WhatsApp)</h2>
            ...
            <div className={styles.card}>
              ...
              <div>
                <h2 className="heading-md" style={{ marginBottom: 'var(--space-1)' }}>Instagram</h2>
                <p className="body-sm text-muted" style={{ marginBottom: 'var(--space-3)' }}>
            ...
            <div className={styles.card}>
              ...
              <div>
                <h2 className="heading-md" style={{ marginBottom: 'var(--space-1)' }}>Showroom & Adres</h2>
